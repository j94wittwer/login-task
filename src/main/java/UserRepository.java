 ...
 *
 * Intent: The UserRepository class handles the storage and retrieval of user objects.
 * provides methods to add, retrieve, update, and remove users from the repository
 * using their unique identifier or username. It also ensures
