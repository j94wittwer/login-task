 ...
 * credential verification, and secure system access.
 *
 * Intent: The AuthenticationService class contains
 * the core logic for user authentication.
 * It provides methods to create users, authenticate users,
 * change usernames and passwords, and delete user accounts.
 * It interfaces with the UserRepository
